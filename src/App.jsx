...
import DecisionMap from "./temporary/Map/DecisionMap";
...
function App() {
  ...
  return (
    <div
      className="App d-flex flex-column vh-100 justify-content-center align-items-center text-center"
      style={{ backgroundColor: "#000", color: "#fff", width: "100%" }}
    >
      <header className="mb-4 w-100" style={{ backgroundColor: "#333" }}>
        <h1>LeetMigo 💻👾</h1>
        <p className="tagline">
          Your based Web5-pilled technical mock interviewer so that you can land
          that awesome software engineering job!⚛️🫡
        </p>
      </header>
      ...
      <div className="d-flex justify-content-center align-items-center">
        ...
        <form className="form-inline" onSubmit={switchAccount}>
          <div className="form-group mx-sm-3 mb-2">
            <label htmlFor="didInput" className="sr-only">
              Paste your DID to switch accounts:
            </label>
            <input
              type="text"
